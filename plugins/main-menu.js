...
const handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    // ✅ Enviar dos imágenes primero
    const img1 = './storage/img/menu.jpg'
    const img2 = './storage/img/menu2.jpg'

    await conn.sendFile(m.chat, img1, 'menu.jpg', null, m)
    await conn.sendFile(m.chat, img2, 'menu2.jpg', null, m)

    // ✅ Luego el texto del menú
